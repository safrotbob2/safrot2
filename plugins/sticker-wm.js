...
if (!/webp/.test(mime)) throw '*[❗ملاحظه❗] رد عـلـي الـسـتـيـكـر الـلـي عـاوز تـسـرقـو*'
let img = await m.quoted.download()
if (!img) throw '*[❗ملاحظه❗] لازم تـرد عـلـي الـسـتـيـكـر الـلـي عـاوز تـسـرق حـقـوقـة*'
...
handler.command = /^سرقة|اسرق|حقوق$/i
